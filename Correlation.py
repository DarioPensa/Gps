...
speed=[]
type=[]
streetTypes=['service','residential','tertiary','secondary','primary','trunk','motorway']#,'parking']
...
mergedGps=open(geo_dir+'\Merged5000047.csv')
...
#plt.plot(Reader['Speed'],Reader['Temperature'],'ro')
#plt.show()
plt.close()
